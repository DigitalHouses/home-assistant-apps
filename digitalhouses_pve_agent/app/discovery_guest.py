        ...
        for index, (guest_id_raw, raw) in enumerate(
            ...
            key, item = _sensor(
                ...
                extra_attrs={
                    ...
                    "last_shutdown_timeout_seconds": obj + ".last_shutdown_timeout_seconds | default(none)",
                    "last_shutdown_timeout_ratio": obj + ".last_shutdown_timeout_ratio | default(none)",
                    "last_shutdown_assessment": obj + ".last_shutdown_assessment | default('unknown')",
