    ...
    *,
    ...
    return {
        "test_quick_interval_days": interval_component(
            ...
            "Quick test interval",
            "number.dh_pve_agent_ups_quick_test_interval_days",
            "quick",
        ...
        "test_quick_time": time_component(
            "test_quick_time",
            "Quick test time",
            "time.dh_pve_agent_ups_quick_test_time",
            "quick",
        ...
        "test_deep_interval_days": interval_component(
            ...
            "Deep test interval",
            "number.dh_pve_agent_ups_deep_test_interval_days",
            "deep",
        ...
        "test_deep_time": time_component(
            "test_deep_time",
            "Deep test time",
            "time.dh_pve_agent_ups_deep_test_time",
            "deep",
        ...
        "test_state": {
            ...
            "default_entity_id": "sensor.dh_pve_agent_ups_test_state",
            "state_topic": topics.state,
            "value_template": (
        ...
        "last_quick_test": last_test_component(
            "last_quick_test",
            "Last Quick test",
            "sensor.dh_pve_agent_ups_last_quick_test",
            "quick",
        ),
        "next_quick_test": next_test_component(
            "next_quick_test",
            "Next Quick test",
            "sensor.dh_pve_agent_ups_next_quick_test",
            "quick",
        ),
        "last_deep_test": last_test_component(
            "last_deep_test",
            "Last Deep test",
            "sensor.dh_pve_agent_ups_last_deep_test",
            "deep",
        ),
        "next_deep_test": next_test_component(
            "next_deep_test",
            "Next Deep test",
            "sensor.dh_pve_agent_ups_next_deep_test",
            "deep",
        ),
        "test_history": {
            "platform": "sensor",
            ...
            "default_entity_id": "sensor.dh_pve_agent_ups_test_history",
            "state_topic": topics.state,
