        ...
        for index, (guest_id_raw, raw) in enumerate(
            ...
            key, item = _sensor(
                ...
                extra_attrs={
                    ...
                    "next_shutdown_timeout_seconds": current + ".next_shutdown_timeout_seconds | default(none)",
                    "next_shutdown_timeout_ratio": current + ".next_shutdown_timeout_ratio | default(none)",
                    "next_shutdown_assessment": current + ".next_shutdown_assessment | default('unknown')",
...
def build_shutdown_aware_ups_discovery_payload(
    ...
    *,
    ...
    components["trigger_policy"] = {
        ...
        "default_entity_id": "sensor.dh_pve_agent_ups_trigger_policy",
    ...
    components["shutdown_budget"] = {
        ...
        "default_entity_id": "sensor.dh_pve_agent_ups_shutdown_budget",
        "state_topic": topics.state,
