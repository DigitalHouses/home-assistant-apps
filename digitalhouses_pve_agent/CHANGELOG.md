...
- Make shutdown readiness consume `next_shutdown_assessment` and migrate the temporary 0.5.27 internal `current_timeout_*` / `current_assessment` state keys without preserving them as a public contract.
