...
_RELEASE_SOURCE_RE = re.compile(
    r"^digitalhouses_plex_agent-v(?P<version>"
...
class TelemetryClient:
    ...
    def tick(self) -> bool:
        if not self.enabled or not self.released_build:
            return False
    ...
    def delete(self) -> bool:
        ...
        self._save()
        self.log.info("Telemetry installation record deleted")
        return True


class TelemetryRunner:
    """Run best-effort telemetry outside all Plex/MQTT monitoring loops."""
