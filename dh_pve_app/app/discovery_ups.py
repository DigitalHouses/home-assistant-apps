    ...
    components: dict[str, Any] = {
        ...
        "shutdown_policy": {
            ...
            "json_attributes_template": (
                ...
                "'power_restore_behavior': value_json.shutdown_policy.power_restore_behavior | default('Not configured'), "
                "'on_battery_delay_minutes': value_json.shutdown_policy.on_battery_delay_minutes | default(none), "
                "'power_restore_delay_seconds': value_json.shutdown_policy.power_restore_delay_seconds | default(none)} | tojson }}"
            ),
        },
