    ...
    *,
    ...
    components: dict[str, Any] = {
        ...
        "policy_emergency_runtime_reserve": {
            ...
            "unique_id": uid("policy_emergency_runtime_reserve"),
            "default_entity_id": "number.dh_pve_ups_policy_emergency_runtime_reserve",
            "state_topic": topics.state,
            "value_template": "{{ value_json.policy.draft.emergency_runtime_reserve_minutes | default(15) }}",
            "command_topic": topics.policy_emergency_runtime_reserve_set,
            "min": 10,
            "max": 30,
            "step": 1,
            "unit_of_measurement": "min",
