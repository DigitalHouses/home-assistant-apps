...
SETTING_SPECS: dict[str, SettingSpec] = {
    "storage_percent_used_threshold": _spec(
        ...
        maximum=98,
        step=1,
        entity_id="number.dh_app_pve_storage_percent_used_threshold",
    ...
    "cpu_temperature_threshold": _spec(
        ...
        maximum=110,
        step=1,
        entity_id="number.dh_app_pve_cpu_temperature_threshold",
    ...
    "hdd_temperature_threshold": _spec(
        ...
        maximum=70,
        step=1,
        entity_id="number.dh_app_pve_hdd_temperature_threshold",
    ...
    "ssd_temperature_threshold": _spec(
        ...
        maximum=90,
        step=1,
        entity_id="number.dh_app_pve_ssd_temperature_threshold",
    ...
    "nvme_temperature_threshold": _spec(
        ...
        maximum=110,
        step=1,
        entity_id="number.dh_app_pve_nvme_temperature_threshold",
    ...
    "gpu_temperature_threshold": _spec(
        ...
        maximum=110,
        step=1,
        entity_id="number.dh_app_pve_gpu_temperature_threshold",
