...
def test_0517_version_and_repository_validator_contract():
    assert (APP / "VERSION").read_text(encoding="utf-8").strip() == "0.5.17"

    text = VALIDATOR.read_text(encoding="utf-8")
    assert 'EXPECTED_VERSION = "0.5.17"' in text


def test_0517_home_assistant_package_layout():
...
def test_0517_operational_guide_contract():
